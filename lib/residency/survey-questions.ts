...
const week2Questions: SurveyQuestion[] = [
  ...
  { key: 'w2_mentor_connection', text: 'How connected do you feel to your Cohort Guide?', type: 'scale' },
...
const week6Questions: SurveyQuestion[] = [
  ...
  { key: 'w6_mentor_feedback', text: 'How useful has your Cohort Guide\'s feedback been?', type: 'scale' },
...
const completionQuestions: SurveyQuestion[] = [
  ...
  { key: 'comp_mentor_impact', text: 'How impactful was your Cohort Guide relationship on your development?', type: 'scale' },
