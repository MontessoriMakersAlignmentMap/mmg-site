        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div>
            ...
            <div className="bg-[#F2EDE6] border-l-4 border-[#d6a758] px-6 py-5 mb-10">
              ...
              <p className="text-[#0e1a7a] text-sm font-semibold mb-3">124 pages &middot; Word + Google Docs</p>
              <ul className="space-y-1.5">
                {['Full 124-Page Handbook Template', 'Adult Culture Chapter', 'Evaluation & Appraisal Section', 'Editable in Word & Google Docs', 'Implementation Guide'].map((c) => (
