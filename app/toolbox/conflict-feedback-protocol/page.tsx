          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
            <div>
              ...
              <div className="bg-[#F2EDE6] border-l-4 border-[#d6a758] px-6 py-5 mb-10">
                ...
                <p className="text-[#0e1a7a] text-sm font-semibold mb-3">7 tools &middot; Editable DOCX</p>
                <ul className="space-y-1.5">
                  {['Protocol Guide (PDF + editable)', 'Conflict Intake Template', 'Stage-by-Stage Facilitation Framework', 'Peer & Supervisor Feedback Guides', 'Equity Review Checklist', 'Administrator Implementation Guide', 'Definitions & Terms Glossary'].map((c) => (
