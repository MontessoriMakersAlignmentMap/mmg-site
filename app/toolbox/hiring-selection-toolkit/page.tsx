    ...
    <>
          ...
          <div>
            ...
            <div className="bg-[#F2EDE6] border-l-4 border-[#d6a758] px-6 py-5 mb-10">
              ...
              <ul className="space-y-1.5">
                {['Job Description Templates (12)', 'Interview Question Bank (60+ questions)', 'Candidate Evaluation Rubrics (6)', 'Reference Check Guides (3)', 'Offer Letter Templates (4)', 'Onboarding Checklist', 'Equitable Hiring Process Guide'].map((c) => (
      ...
      <section className="bg-white py-24 md:py-28 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <object
            data="/toolbox-previews/hiring-selection-toolkit-preview.pdf#toolbar=0&navpanes=0"
