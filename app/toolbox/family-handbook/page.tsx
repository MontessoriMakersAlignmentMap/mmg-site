    ...
    <>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div>
            ...
            <div className="bg-[#F2EDE6] border-l-4 border-[#d6a758] px-6 py-5 mb-10">
              ...
              <p className="text-[#0e1a7a] text-sm font-semibold mb-3">58 pages &middot; Word + Google Docs</p>
              <ul className="space-y-1.5">
                {['Full 58-Page Handbook Template', 'Philosophy Section', 'Community Standards Language', 'Editable in Word & Google Docs'].map((c) => (
      ...
      <section className="bg-white py-24 md:py-28 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <object
            data="/toolbox-previews/family-handbook-toolkit-preview.pdf#toolbar=0&navpanes=0"
