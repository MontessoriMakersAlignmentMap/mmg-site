      ...
      <section className="bg-[#FAF9F7] py-24 md:py-32 px-6 md:px-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          <div className="relative aspect-[4/5] rounded-xl overflow-hidden shadow-[0_8px_32px_rgba(14,26,122,0.10)]">
            <Image src="/images/toolbox/annual-cycle-planning-toolkit.png"
          ...
          <div>
            ...
            <div className="bg-[#F2EDE6] border-l-4 border-[#d6a758] px-6 py-5 mb-10">
              ...
              <p className="text-[#0e1a7a] text-sm font-semibold mb-3">6 templates &middot; Editable DOCX</p>
              <ul className="space-y-1.5">
                {['Month-by-Month Leadership Calendar', 'Board Annual Calendar Template', 'Enrollment Rhythm Map', 'Staff Cycle Planning Guide', 'Budget Calendar Framework', 'Annual Reporting Template'].map((c) => (
