...
export default function CompensationFrameworkThankYouPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl">
            ...
            <p className="text-[#94A3B8] text-xl leading-relaxed mb-10 max-w-xl">
              Your Compensation Framework Toolkit is ready. Click below to download the toolkit.
            </p>
            <a href="/toolbox-downloads/compensation-framework-toolkit.docx"
              download="MMG-Compensation-Framework-Toolkit.docx"
      ...
      <section className="bg-[#F2EDE6] py-14 px-6 md:px-10 border-b border-[#D4CEC6]">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[#374151] text-base leading-relaxed">
            Begin with the Compensation Philosophy Guide before building bands or running the workbook. The philosophy
            anchors every other decision. Then use the Salary Banding Framework to define role groups, populate the
            Excel workbook with your staff, and run the equity audit after the bands are in place.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { name: 'Staff Retention Toolkit', href: '/toolbox/staff-retention-toolkit' },
                { name: 'Performance Concerns & Separation Toolkit', href: '/toolbox/performance-separation-toolkit' },
