...
const programs = [
  {
    ...
    name: 'Primary',
    ages: 'Ages 3–6',
    photo: 'https://images.unsplash.com/photo-8H0EBM9LCZQ?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    ages: 'Ages 6–9',
    photo: 'https://images.unsplash.com/photo-vr2l5FGuJQI?auto=format&fit=crop&w=1200&q=80',
  ...
  return (
    <SchoolPage>
      ...
      <section style={{ position: 'relative', height: '60vh', minHeight: 400, overflow: 'hidden', display: 'flex', alignItems: 'flex-end', paddingBottom: 64, paddingTop: 164 }}>
        <Image
          src="https://images.unsplash.com/photo-oKe_Dwv-Kkk?auto=format&fit=crop&w=2000&q=80"
          alt="MMS classroom"
          fill
