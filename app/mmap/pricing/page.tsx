...
const tiers = [
  {
    ...
    tagline: 'For classroom guides and individual programs focused on Montessori documentation and student visibility.',
    features: [
      'Lesson tracking & presentation log',
      'Montessori album — full curriculum library',
      'Observations & portfolios with work-sample attachments',
      'Student progress maps & mastery tracking',
      'Standards alignment & CCSS mapping',
      'Classroom management & guide assignment',
      'Classroom Guide View — overdue-presentation flags (New)',
      'Substitute Plans Generator (New)',
      'Transition Library — songs, finger plays, grounding activities (New)',
    ],
  ...
  },
  {
    ...
    tagline: 'For schools ready to consolidate operations into one platform.',
    features: [
      'Everything in Surveyor',
      'Full Student Information System (SIS)',
      'Daily attendance — staff & student, patterns',
  ...
  },
  {
    ...
    tagline: 'For schools managing the full enrollment lifecycle, adult culture, and equity.',
    features: [
      'Everything in North Star',
      'Full Admissions CRM — pipeline, tours, offers, placement builder',
      'HR Hub — hiring, onboarding, appraisals, coaching, PTO',
      'Adult culture tools — role clarity, culture hub, upward feedback',
      'Equity dashboards — ABAR pathways, pulse surveys, demographics',
      ...
      'Conference Prep Packet — lessons, photos, work samples per child (New)',
      'Child Arc — multi-year longitudinal view across classrooms (New)',
    ],
    implementation: true,
    highlight: true,
  },
  {
    ...
    tagline: 'For schools and networks requiring board-level visibility and strategic insight.',
    features: [
      'Everything in Mapmaker',
      'Board dashboard, snapshots & governance reports',
      'Strategic Planning Hub — multi-year goals & progress tracking',
      'Financial equity analysis & mission-linked budgeting',
      'Leader\'s Desk Dashboard — decisions, risks, rhythm (New)',
      'Embedded email drafting — 4 tones, for hard messages (New)',
