...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      'Compliance, handbooks, and intervention tracking',
    ],
    implementation: true,
    highlight: false,
  },
  {
    ...
    features: [
      ...
      'Full admissions CRM',
      'HR hub with appraisals, coaching, and hiring pipeline',
      'Equity dashboards and ABAR pathways',
      'Progress reports and conference tools',
  ...
  },
  {
    ...
    features: [
      ...
      'Executive AI insights and mission-linked budgeting',
      'Advanced equity and financial analytics',
      'Data retention, archiving, and platform admin',
    ],
    implementation: true,
    highlight: false,
  },
