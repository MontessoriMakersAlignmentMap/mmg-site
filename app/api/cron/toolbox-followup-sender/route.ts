...
Compensation Framework Toolkit ($395): Pay philosophy, salary banding, annual review cycle, equity audit, and Excel workbook. Tip: build the Compensation Philosophy Guide before touching the salary bands — the philosophy anchors every decision that follows. Pairs well with: Staff Retention Toolkit.
Enrollment Systems Toolkit ($425): End-to-end enrollment infrastructure from inquiry through re-enrollment. Tip: start with the Enrollment Process Map to identify where your pipeline is weakest before implementing individual components. Pairs well with: Annual Cycle Planning Toolkit.
New Leader Onboarding Toolkit ($375): Structured first 90 days for incoming heads of school and directors. Tip: schedule the 90-Day Review with your board before your first week so it happens on time rather than when everyone remembers. Pairs well with: Leadership Transition and Succession Toolkit.
Staff Retention Toolkit ($325): Stay interviews, working conditions assessment, exit analysis, and retention culture practices. Tip: begin stay interviews with your highest-risk, highest-impact staff first rather than working through everyone at once. Pairs well with: Adult Culture Framework.
Annual Cycle Planning Toolkit ($225): Month-by-month leadership calendar, board calendar, enrollment rhythm map, and staff cycle planning. Tip: adapt the Month-by-Month Leadership Calendar to your school's specific dates before building out the board and staff templates. Pairs well with: Montessori Leadership Operations Playbook.
Financial Literacy for Montessori Leaders ($275): Budget construction, financial statements, cash flow management, reserve strategy, and board finance conversations. Tip: work through Reading Your Financial Statements alongside your school's actual financials — the learning lands much better with real numbers. Pairs well with: Board Onboarding and Alignment Toolkit.
The Montessori Equity Audit: Toolbox Edition ($197): 48-page self-guided diagnostic with 38 evidence-based questions across 4 domains, a self-scoring guide, a four-round debrief protocol, and a next-steps framework. Tip: do not skip the conditions step — confirm a facilitator who is not the head of school and communicate the three commitments to the team before anyone opens the instrument, or the diagnostic will produce affirmation instead of evidence. Pairs well with: Adult Culture Framework.
