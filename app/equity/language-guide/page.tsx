...
export default function EquityLanguageGuidePage() {
  return (
    <>
      {/* Header */}
      <section className="bg-[#0e1a7a] pt-32 pb-12 md:pt-40 md:pb-16 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div>
              <p className="text-[#d6a758] text-xs tracking-[0.2em] uppercase mb-4">Language & Terminology</p>
              <h1 className="text-4xl md:text-5xl text-white leading-tight" style={serif}>
                Language and<br className="hidden md:block" /> Terminology Guide
              </h1>
              <p className="text-[#94A3B8] text-base leading-relaxed mt-4 max-w-xl">
                Not a glossary to memorize. A set of intentional choices — and the reasoning behind them — that invites you to examine your own.
              </p>
            </div>
            <a
              href="/equity-language-guide.pdf"
              download="MMG-Language-and-Terminology-Guide.pdf"
      ...
      <section className="bg-[#FAF9F7] px-6 md:px-10 py-10">
        <div className="max-w-7xl mx-auto">
          <div className="border border-[#E2DDD6] overflow-hidden" style={{ height: '85vh', minHeight: '600px' }}>
            <iframe
              src="/equity-language-guide.pdf#toolbar=1&navpanes=0&scrollbar=1"
              className="w-full h-full"
              title="MMG Language and Terminology Guide"
            />
          </div>
          <p className="text-[#94a3b8] text-xs mt-3 text-center">
            Use your browser&apos;s zoom controls to resize. Having trouble viewing?{' '}
            <a href="/equity-language-guide.pdf" download className="underline hover:text-[#64748B]">
