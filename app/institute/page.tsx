              ...
              <div className="p-8 md:p-10 grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-[#64748B] text-xs">
                    ...
                    Lead teachers, heads of school, academic directors, and anyone in a Montessori school responsible for adult culture — who understand the pedagogy and are ready to examine what they actually do with and to one another.
                  </p>
                </div>
                {/* Sidebar */}
